...
if (typeof context.OnekeyWallet === 'undefined') {
  context.OnekeyWallet = OnekeyWallet
}
...
ProviderEngine.prototype.send = function (payload) {
  ...
  switch (payload.method) {
    ...
    default:
      var message = `The OneKeyWallet Web3 object does not support synchronous methods like ${payload.method} without a callback parameter.`
